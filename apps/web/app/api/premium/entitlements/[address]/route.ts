import {
  getActivePremiumEntitlementsWithSingleRetry,
  summarizeEntitlements,
} from '@revoke.cash/core/premium/entitlements';
...
export async function GET(req: NextRequest, props: Props) {
  try {
    ...
    try {
      ...
      return NextResponse.json(summarizeEntitlements(address, entitlements), {
        headers: {
      ...
      return NextResponse.json({ isPremium: false, isUltimate: false, ownTier: null, grantedTier: null });
    }
  } catch (error) {
